    ...
    methods (Access = private) 
        ...
        function getChannelInfo(obj)
            ...
            %   Retrieve channel info from TMSi device.
             channel_list= ["FP1" "FPZ" "FP2" "F7 " "F3 " "FZ " "F4 " "F8 " "FC5" "FC1" "FC2" "FC6" "M1 " "T7 " "C3 " "CZ " "C4 " "T8 " "M2 " "CP5" "CP1" "CP2" "CP6" "P7 " "P3 " "PZ " "P4 " "P8 " "POZ" "O1 " "OZ " "O2 " "AF7" "AF3" "AF4" "AF8" "F5 " "F1 " "F2 " "F6 " "FC3" "FCZ" "FC4" "C5 " "C1 " "C2 " "CP3" "C6 " "CPZ" "CP4" "P5 " "P1 " "P2 " "P6 " "PO5" "PO3" "PO4" "PO6" "FT7" "FT8" "TP7" "TP8" "PO7" "PO8" "Ch65" "Ch66" "Ch67" "Ch68" "Ch69" "Ch70" "Ch71" "Ch72" "Digi" "Saw"];
            ...
            for i=0:(signal_format.Value.Elements - 1)
                ...
                obj.channels{i + 1}.name = char(channel_list(i+1)); %Make the name of the channels correspond to their location on a 64 channel cap
